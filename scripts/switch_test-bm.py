...
class SwitchManager():
	...
	def standalone_conf(self):
		...
		self.mcli_command("port setQMode 6 2")
		self.mcli_command("port setQMode 7 2")
		self.mcli_command("port setQMode 8 2")
		self.mcli_command("port setQMode 9 2")
		...
		self.mcli_command("phy powerDown 5 disable")
		self.mcli_command("phy powerDown 6 disable")
		self.mcli_command("phy powerDown 7 disable")
		self.mcli_command("phy powerDown 8 disable")

		self.mcli_command("port setPortState 2 3")
		self.mcli_command("port setPortState 3 3")
		self.mcli_command("port setPortState 4 3")
		self.mcli_command("port setPortState 5 3")
		self.mcli_command("port setPortState 6 3")
		self.mcli_command("port setPortState 7 3")
		self.mcli_command("port setPortState 8 3")
		...
		self.mcli_command("port setDefVid  5 5")
		self.mcli_command("port setDefVid  6 6")
		self.mcli_command("port setDefVid  7 7")
		self.mcli_command("port setDefVid  8 8")
		...
		self.mcli_command("vlan addEntry -fid 1 -vid 1 -TagP {3 1 3 3 3 2 3 3 3 3 3}")
		self.mcli_command("vlan addEntry -fid 1 -vid 2 -TagP {3 3 1 1 3 3 3 3 3 3 3}")
		self.mcli_command("vlan addEntry -fid 1 -vid 3 -TagP {3 3 1 1 3 3 3 3 3 3 3}")
		self.mcli_command("vlan addEntry -fid 1 -vid 4 -TagP {3 3 3 3 1 1 3 3 3 3 3}")
		self.mcli_command("vlan addEntry -fid 1 -vid 5 -TagP {3 3 3 3 1 1 3 3 3 3 3}")
		self.mcli_command("vlan addEntry -fid 1 -vid 6 -TagP {3 3 3 3 3 3 1 1 3 3 3}")
		self.mcli_command("vlan addEntry -fid 1 -vid 7 -TagP {3 3 3 3 3 3 1 1 3 3 3}")
		self.mcli_command("vlan addEntry -fid 1 -vid 8 -TagP {3 3 3 3 3 3 3 3 1 2 3}")
...
def system_init():
	...
	print "  Create eth0.1 eth0.8 i/f for getting receiving statistic"
	os.system("ip link add link eth0 name eth0.4 type vlan id 8 > /dev/null 2>&1; ifconfig eth0.8 192.168.8.1; ip link set dev eth0.8 up")
...
def main():
	...
	print "Test Done..."
	sw_mgr.mcli_dump_cnt(1)
	sw_mgr.mcli_dump_cnt(2)
	sw_mgr.mcli_dump_cnt(3)
	sw_mgr.mcli_dump_cnt(4)
	sw_mgr.mcli_dump_cnt(5)
	sw_mgr.mcli_dump_cnt(6)
	sw_mgr.mcli_dump_cnt(7)
	sw_mgr.mcli_dump_cnt(8)
	sw_mgr.mcli_dump_cnt(9)
